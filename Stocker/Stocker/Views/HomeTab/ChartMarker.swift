...
class ChartMarker: MarkerView {
    ...
    override func draw(context: CGContext, point: CGPoint) {
        ...
        drawAttributes[.backgroundColor] = #colorLiteral(red: 0.001231680741, green: 0.6993102431, blue: 0.9645704627, alpha: 1)
        ...
        drawText(text: " \(text)원 " as NSString,
    ...
    func drawText(text: NSString, rect: CGRect, withAttributes attributes: [NSAttributedString.Key : Any]? = nil) {
        ...
        let centeredRect = CGRect(x: rect.origin.x + (rect.size.width - size.width) / 2.0,
